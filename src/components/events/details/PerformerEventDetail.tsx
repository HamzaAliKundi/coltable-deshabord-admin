        ...
        <div className="bg-black p-4 md:p-8 w-full mb-32">
            <div className="max-w-4xl mx-auto">
                <div className="bg-[#212121] rounded-[8px] p-6">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-400">
                                ...
                                <div>
                                    ...
                                    {event.isPrivate !== null && <p className="text-sm">Private Event: {event.isPrivate ? 'Yes' : 'No'}</p>}
                                </div>
                            </div>
                        </div>
                    </div>
                    {event.description && (
                        <div className="mt-6">
                            <h2 className="text-white font-['Space_Grotesk'] font-bold text-xl mb-2">Description</h2>
